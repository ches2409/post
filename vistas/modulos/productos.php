  ...
  <section class="content">
    ...
    <div class="box box-success">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-flat btn-default" data-toggle="modal" data-target="#modalAgregarProducto">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="nuevoCodigo" name="nuevoCodigo" placeholder="Código de barras">

              </div>

            </div>

            <!-- ENTRADA PARA EL CÓDIGO DE BARRAS-->
            ...
            <!-- <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="nuevoCodigoBarras" name="nuevoCodigoBarras" placeholder="Código de barras">
