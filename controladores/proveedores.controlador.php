...
class ControladorProveedores{
	...
	static public function ctrCrearProveedor(){
		...
		if(isset($_POST["nuevoProveedor"])){
			...
			//    preg_match('/^[0-9]+$/', $_POST["nuevoDocumentoProveedor"]) &&
			...
			//    preg_match('/^[()\-0-9 ]+$/', $_POST["nuevoTelefono"]) && 
			   preg_match('/^[#\.\-a-zA-Z0-9 ]+$/', $_POST["nuevaDireccion"])){
			   	...
			   	$datos = array("nombre"=>$_POST["nuevoProveedor"],
					           "documento"=>$_POST["nuevoDocumentoProveedor"],
					           "email"=>$_POST["nuevoEmail"],
					           "telefono"=>$_POST["nuevoTelefono"],
					           "direccion"=>$_POST["nuevaDireccion"],
                               "ciudad"=>$_POST["nuevaCiudad"],
                               "nombre_contacto"=>$_POST["nuevoContacto"],
                               "telefono_contacto"=>$_POST["nuevoTelefonoContacto"],
	...
	static public function ctrEditarProveedor(){
		...
		if(isset($_POST["editarProveedor"])){
			...
			//    preg_match('/^[0-9]+$/', $_POST["editarDocumentoProveedor"]) &&
			...
			//    preg_match('/^[()\-0-9 ]+$/', $_POST["editarTelefono"]) && 
			   preg_match('/^[#\.\-a-zA-Z0-9 ]+$/', $_POST["editarDireccion"])){
			   	...
			   	$datos = array("id"=>$_POST["idProveedor"],
					           ...
					           "documento"=>$_POST["editarDocumentoProveedor"],
					           "email"=>$_POST["editarEmail"],
					           "telefono"=>$_POST["editarTelefono"],
                               "direccion"=>$_POST["editarDireccion"],
                               "ciudad"=>$_POST["editarCiudad"],
                               "nombre_contacto"=>$_POST["editarNombreContacto"],
                               "telefono_contacto"=>$_POST["editarTelefonoContacto"],
